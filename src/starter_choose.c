...
#define GRASS_STARTER (IS_FRLG ? SPECIES_MANKEY  : SPECIES_MANKEY)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_SOLOSIS : SPECIES_SOLOSIS)
#define WATER_STARTER (IS_FRLG ? SPECIES_DEINO   : SPECIES_SNIVY )
