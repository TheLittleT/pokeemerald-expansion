...
const u32 gTrainerFrontPic_Clown[] = INCGFX_U32("graphics/trainers/front_pics/clown.png", ".4bpp.smol");
const u16 gTrainerPalette_Clown[] = INCGFX_U16("graphics/trainers/palettes/clown.pal", ".gbapal");
